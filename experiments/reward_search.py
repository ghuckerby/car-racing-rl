...
def objective(trial):
    ...
    experiment_name = f"meta_trial_{trial.number}_seed0"
...
def run_reward_search(n_trials=20):
    os.makedirs("results/meta_learning", exist_ok=True)
    storage = "sqlite:///results/meta_learning/reward_search.db"
    ...
    output_path = "results/meta_learning/best_weights.json"
